...
import com.example.model.payload.UploadFileResponse;
...
public class FileController {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FileController.class.getName());
